    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Sur cette page vous trouverez la liste des utilisateurs du site ainsi que la création de nouveaux
                    comptes.</p>
            </div>
        </div>
    </div>
                    ...
                    <form role="form">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" id="userName" name="name" placeholder="Smith John"
                                       type="text" required/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="userUser" name="user" placeholder="jSmith" type="text"
                                       required/>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            if (isset($data['users'])) {
                                foreach ($data['users'] as $user) { ?>
                                    <tr id="user<?= $user->id ?>">
                                        ...
                                        <td><?= $user->rank; ?></td>
                                        <td>
                                            <button class="btn btn-link" name="updateUser"
                                                    value="<?= $_SESSION['form_token']; ?>"
                                                    formaction="advisor/UpdateUser" formmethod="post">
                                            </button>
                                        </td>
                                        <td>
                                            <button class="btn btn-link" name="deleteUser"
                                                    value="<?= $_SESSION['form_token']; ?>"
                                                    formaction="advisor/DeleteUser" formmethod="post">
                                            </button>
                                        </td>
                                    </tr>
                                <?php }
