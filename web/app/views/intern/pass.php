                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <form role="form">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="newPass" placeholder="Nouveau mot de passe" type="password">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="newVerif">Verifier le mot de passe</label>
                                <input class="form-control" id="newVerif" placeholder="Entrer de nouveau" type="password">
                            </div>
                            <div class="row">
                                <div class="col-md-8">
