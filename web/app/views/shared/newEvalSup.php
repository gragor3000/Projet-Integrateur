<!--Nouvelle &eacute;valuation du stagiaire par le superviseur-->
<body>
   ...
   <label>Nom de l&apos;entreprise : </label>
      <br>
    <input type = "text" id = "entName" name = "entName" class="form-control" required />
   <br>
   <label>Date  : </label>
   ...
   <!--Commentaires objectif #1-->
	...
	<textarea rows="4" cols="50" id = "objCrit1" name = "objCrit1" class="form-control" required></textarea>
	<br>
  ...
  <legend>3.	Produire la documentation relative &agrave; l&apos;application.</legend>
   <table>
	...
	<p>Suite &agrave; ces constats avez-vous des commentaires ou des suggestions &agrave; formuler? : </p>
	<textarea rows="4" cols="50" id = "objCrit2" name = "objCrit2" class="form-control" required></textarea>
	<br>
   ...
   <table>
	...
	<p>Suite &agrave; ces constats avez-vous des commentaires ou des suggestions &agrave; formuler? : </p>
	<textarea rows="4" cols="50" id = "objCrit3" name = "objCrit3" class="form-control" required></textarea>
	<br>
	<h3>Commentaires</h3>
	...
	<br>
	<textarea rows="4" cols="50" id = "objCrit4" name = "objCrit4"  class="form-control" required></textarea>
	<br>
	<label>- POINTS &Agrave; AM&Eacute;LIORER</label>
	<br>
	<textarea rows="4" cols="50" id = "objCrit5" name = "objCrit5"  class="form-control" required></textarea>
	<br>
	<label>- AUTRES REMARQUES</label>
	<br>
	<textarea rows="4" cols="50" id = "objCrit6" name = "objCrit6" class="form-control" required></textarea>
