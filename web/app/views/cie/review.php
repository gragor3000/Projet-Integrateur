									...
									<tr>
										...
										<td>
											<select class="form-control" id="cieRevAgain" name="cieRevAgain" <?= (isset($data['readOnly']) && $data['readOnly']) ? 'disabled' : ''; ?>>
												<option value="oui" <?= (isset($data['review']) && $data['review']->cieRevAgain=="oui") ? 'selected' : ''; ?>>Oui</option>
												<option value="non" <?= (isset($data['review']) && $data['review']->cieRevAgain=="non") ? 'selected' : ''; ?>>Non</option>
											</select>
										</td>
									</tr>
									<tr>
