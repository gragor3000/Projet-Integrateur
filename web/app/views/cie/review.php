				...
				<div class="col-md-12">
					<div class="row well">
						<div class="form-group col-md-4">
							<label class="control-label" for="intIntern">Nom du stagiaire</label>
							<p style="margin-top:7px;">Prénom Nom</p>
						</div>
						<div class="form-group col-md-6">
							<label class="control-label" for="intIntern">Titre du projet</label>
							<p style="margin-top:7px;">Projet de stage</p>
						</div>
						<div class="form-group col-md-2">
							<label class="control-label" for="intIntern">Date</label>
							<p style="margin-top:7px;">2016-03-31</p>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="control-label" for="revComment1">Commentaires et suggestions</label>
							<textarea class="form-control" id="revComment1"></textarea>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="control-label" for="revComment2">Commentaires et suggestions</label>
							<textarea class="form-control" id="revComment2"></textarea>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="control-label" for="revComment2">Points forts</label>
							<textarea class="form-control" id="revComment2"></textarea>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-12">
							<label class="control-label" for="revComment2">Points à améliorer</label>
							<textarea class="form-control" id="revComment2"></textarea>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-12">
							<label class="control-label" for="revComment2">Autres remarques</label>
							<textarea class="form-control" id="revComment2"></textarea>
						</div>
					</div>
